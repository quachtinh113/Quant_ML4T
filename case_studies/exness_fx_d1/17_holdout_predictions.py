...
# %% [markdown]
# # Holdout Predictions - Exness FX D1
#
...
#
#
# **Bot `exness_fx_d1`, copied from [`fx_pairs/17_holdout_predictions`](../fx_pairs/17_holdout_predictions.ipynb).**
...
WORKSPACE: str = ""
CANDIDATE_SET_NAME = "exness_fx_d1:holdout-candidates"
