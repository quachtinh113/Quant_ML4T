...
CASE_STUDY_META = {
    ...
    # Bot case study, a Route B fork of fx_pairs on MT5 history (bots/exness_fx_d1/BOT.md).
    # Its registry starts empty; every loader below skips a case study without one.
    "exness_fx_d1": {"display_name": "Exness FX D1", "chapter_track": "Ch6 to Ch20"},
    # Bot case study, a Route B fork of exness_fx_d1 on the same MT5 history but a SESSION
    # decision grid, two a weekday (bots/exness_gold_sess/BOT.md). Registry starts empty.
    "exness_gold_sess": {"display_name": "Exness Gold Sessions", "chapter_track": "Ch6 to Ch20"},
    # Bot case study, a Route B fork of exness_fx_d1 on MT5 H1 history with TWO NYSE cash-session
    # decisions a day (bots/exness_usidx_sess/BOT.md). Registry starts empty.
    "exness_usidx_sess": {
        "display_name": "Exness US Index Sessions",
        "chapter_track": "Ch6 to Ch20",
    },
}
...
PRIMARY_LABELS = {
    ...
    "exness_fx_d1": "fwd_ret_1d",
    "exness_gold_sess": "fwd_ret_8h",
    "exness_usidx_sess": "fwd_ret_intraday",
}
...
SHORT_NAMES = {
    ...
    "exness_fx_d1": "Exness FX",
    "exness_gold_sess": "Gold Sessions",
    "exness_usidx_sess": "US Index Sessions",
}
...
DATASET_META = {
    ...
    "exness_fx_d1": {"frequency": "Daily", "entities": 5, "horizon": "1d"},
    # Two decision slots a weekday (London open + 1h, New York open + 1h), so "Session"
    # rather than a bar frequency; the bars underneath are H1.
    "exness_gold_sess": {"frequency": "Session", "entities": 2, "horizon": "8h"},
    # Two decision slots per NYSE cash session (open + 30 minutes, and the close), so "Session"
    # rather than a bar frequency; the bars underneath are H1. The two labels partition the
    # session: about six hours intraday, about seventeen overnight.
    "exness_usidx_sess": {"frequency": "Session", "entities": 2, "horizon": "session"},
}
...
CADENCE_MAP = {
    ...
    "exness_fx_d1": "daily",
    "exness_gold_sess": "session",
    "exness_usidx_sess": "session",
}
